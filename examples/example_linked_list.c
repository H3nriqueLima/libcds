...
Objetivo: mostrar as funções principais em um cenário realista (uma lista
de "tarefas"), incluindo o caso mais delicado: valores alocados
dinamicamente (malloc) e como liberá-los certo com destroy_with_values.
